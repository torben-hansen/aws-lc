...
static bool Speed25519(const std::string &selected) {
  ...
  if (!TimeFunction(&results, []() -> bool {
    ...
    fprintf(stderr, "Curve25519 base-point + Curve25519 arbitrary point multiplication failed.\n");
    return false;
  }

  results.Print("Curve25519 base-point + Curve25519 arbitrary point multiplication");
